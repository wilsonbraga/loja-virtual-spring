...
import wilson.braga.lojavirtual.enums.StatusContaPagar;
...
public class ContaPagar implements Serializable {
	...
	@ManyToOne(targetEntity = Pessoa.class)
	@JoinColumn(name = "pessoa_formecedor_id", nullable = false, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "pessoa_formecedor_fk"))
